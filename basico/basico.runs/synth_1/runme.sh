...
HD_PWD='C:/Users/njimenezs/Documents/arqui/clase2026/basico/basico.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log suma4bitr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source suma4bitr.tcl
